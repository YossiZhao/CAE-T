...
#         _log_api_usage_once(self)
        ...
        self.conv1 = nn.Conv1d(19, self.inplanes, kernel_size=7, stride=2, padding=3, bias=False)
...
#             )
            downsample = nn.Sequential(          #  --yossi
                conv1x1_downsample(self.inplanes, planes*block.expansion, stride, padding=0),
                norm_layer(planes * block.expansion),
            )
