...
#         _log_api_usage_once(self)
        ...
        self.inplanes = self.n_channels * 4     #   from 19*8=152 to 19*64=1216  --yossi
        self.dilation = 1
        ...
        self.conv1 = nn.Conv1d(self.n_channels, self.inplanes, kernel_size=64, groups=self.groups, stride=2, padding=3, bias=False)    #  n_channels*4 = 152  --yossi
        ...
        self.avgpool_2 = nn.AdaptiveAvgPool2d((self.groups, self.d_model))    # need to modify  --zys
...
# 2min: 6000, 2^4-->375, avgpool-->256
def res_encoderXS(*, weights = None, progress: bool = True, **kwargs: Any) -> AutoEncoder:  
...
def res_encoderXL(*, weights = None, progress: bool = True, **kwargs: Any) -> AutoEncoder:
    ...
    return _autoencoder(Bottleneck, [3, 4, 8, 12, 8, 6, 3, 2], progress, **kwargs)
