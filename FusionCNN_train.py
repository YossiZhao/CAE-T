...
#             writer.flush()
        ...
        torch.save(cnn_model.state_dict(), Configs['checkpoint']['checkpoint_dir']+ f'{datetime.now().strftime("%y%m%d%H%M")}_{model_name}_params_epoch_{epoch+1}_acc{accuracy_signal:04f}.pth')
